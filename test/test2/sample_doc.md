...
![段落スタイルをソースコード用のものに指定](img/s4-fig8.png)

![セルマージンを設定](img/s4-fig9.png)
...
![先頭行では上マージンを2mmに設定](img/s4-fig18.png)

![最終行では下マージンを2mmに設定](img/s4-fig17.png)
